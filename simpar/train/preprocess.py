...
from simpar.constants import IGNORE_INDEX, DEFAULT_IMAGE_TOKEN, DEFAULT_IM_START_TOKEN, DEFAULT_IM_END_TOKEN, IMAGE_TOKEN_INDEX
...
PROMPTS_GEN = [
    ...
    "A vibrant, colorful scene of ",
    "A surreal dreamscape of ",
    "A futuristic cityscape with ",
    "An epic landscape showcasing ",
    "A minimalistic black and white sketch of ",
    "A cinematic view of ",
    "An ethereal depiction of ",
    "A hyper-realistic portrayal of ",
    "An imaginative interpretation of ",
    "A whimsical illustration of ",
    "A magical world featuring ",
    "An iconic scene from ",
    "A steampunk-inspired version of ",
    "A vintage-style artwork of ",
    "A high-tech sci-fi scene with "
]
...
def preprocess_plain(
    ...
    for source in sources:
        ...
        if add_prefix_token is not None:
            conversation = add_prefix_token + conversation
        # <|i2t|><image>29 best rachel ashwell shabby chic images on pinterest simply
        conversations.append(conversation)
    # tokenize conversations
...
def preprocess(sources: Sequence[str], tokenizer: transformers.PreTrainedTokenizer, has_image: bool = False, add_prefix_token=None) -> Dict:
    """
    ...
    if conversation_lib.default_conversation.sep_style == conversation_lib.SeparatorStyle.PLAIN:
        return preprocess_plain(sources, tokenizer, add_prefix_token)
